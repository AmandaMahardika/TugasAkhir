...
<head>
    ...
    <style>
        ...
        .blob { position: absolute; z-index: 0; opacity: 0.2; }
                ...
                <tbody class="text-center">
                    @forelse($tindakLanjut as $tindak)
                        <tr class="hover:bg-sky-50 transition">
                            ...
                            <td class="py-3 px-4 capitalize">{{ $tindak->penanganan }}</td>
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4">
                                <a href="{{ route('tindakLanjut.edit', $tindak->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="py-4 text-gray-500 italic text-center">
