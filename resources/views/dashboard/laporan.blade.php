...
<body class="relative bg-gradient-to-br from-orange-100 to-white min-h-screen px-4 py-10 overflow-y-auto overflow-x-hidden">
    ...
    <div class="relative z-10 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl max-w-3xl w-full p-8 fade-up mx-auto">
        ...
        <img id="previewGambar" src="" alt="Gambar Lokasi Ruang" class="rounded shadow-sm mb-6 w-full max-w-md object-contain mx-auto hidden" />

        <form action="{{ route('laporan.store') }}" method="POST" novalidate>
            @csrf

            <div class="mb-5">
                <label for="lokasi_ruang" class="block mb-2 font-semibold text-orange-600">Lokasi Ruang:</label>
                <select name="lokasi_ruang" id="lokasi_ruang" class="w-full border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 rounded-lg" required>
            ...
            <div class="mb-5">
                <label for="detail1" class="block mb-2 font-semibold text-orange-600">Detail 1:</label>
                <select name="detail1" id="detail1" class="w-full border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 rounded-lg" required>
            ...
            <div class="mb-5">
                <label for="detail2" class="block mb-2 font-semibold text-orange-600">Detail 2:</label>
                <select name="detail2" id="detail2" class="w-full border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 rounded-lg" required>
            ...
            <div class="mb-6">
                <label for="deskripsi_kerusakan" class="block mb-2 font-semibold text-orange-600">Deskripsi Kerusakan:</label>
                <textarea name="deskripsi_kerusakan" id="deskripsi_kerusakan" rows="4" class="w-full border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 rounded-lg resize-none" required></textarea>
            </div>

            <div class="flex justify-between gap-4 flex-col sm:flex-row">
                <button type="submit" class="flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-6 rounded-lg transition shadow-md">
