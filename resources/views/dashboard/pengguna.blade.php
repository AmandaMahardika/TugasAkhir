...
<body class="relative bg-gradient-to-br from-sky-200 to-white min-h-screen py-12 px-4 overflow-hidden">
    ...
    <div class="relative z-10 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl max-w-6xl mx-auto p-8 fade-up">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            <div class="flex items-center gap-4">
                <img src="{{ asset('images/undraw_logic_bj1j.svg') }}" alt="Icon" class="w-20 h-auto">
...
<div class="mb-4">
    <a href="{{ route('laporan.create') }}" class="bg-sky-500 hover:bg-sky-600 text-white font-semibold py-2 px-6 rounded-lg shadow-md inline-flex items-center transition">
...
<div class="overflow-x-auto">
    ...
    <div class="overflow-x-auto">
    <table class="min-w-full bg-white rounded-xl shadow text-sm">
        <thead class="bg-sky-500 text-white text-center rounded-t-xl">
            <tr>
                ...
                <tr class="hover:bg-sky-50 transition">
                    ...
                    <td class="py-3 px-4">
                        <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full text-white text-xs font-bold
                            @if(strtolower($laporan->status) == 'pending') bg-yellow-500
                            @elseif(strtolower($laporan->status) == 'selesai') bg-green-600
                            @elseif(strtolower($laporan->status) == 'ditolak') bg-red-500
